            ...
            <div class="table-responsive p-0">
              ...
              <table class="table align-items-center mb-0" id="example">
                ...
                <tbody>
                  ...
                  $data = mysqli_query($conn, "SELECT users.*,role.nama_role FROM users INNER JOIN role ON role.id_role = users.role ");
                  while ($d = mysqli_fetch_array($data)) {
                  ?>
                    <tr>

                      <td align="center">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $d['id']; ?></p>
                      ...
                      <td align="center">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $d['jenis_kel']; ?></p>
                      ...
                      <td align="center">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $d['nama_role']; ?></p>

                      </td>

                      <td class="align-middle" style="">
                        <div class="ms-auto text-end">
                          <a class="btn text-danger bg-danger px-3 mb-0 " href="#" data-bs-toggle="modal" data-bs-target="#exampleModal2<?php echo $d['id']; ?>"><i class="far fa-trash-alt text-white "></i></a>


                          <div class="modal fade" id="exampleModal2<?= $d['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <a href="?page=del-users&kode=<?php echo $d['id']; ?>">
