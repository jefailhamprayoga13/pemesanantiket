    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
                ...
                <span class="ms-1 font-weight-bold">Pemesanan Tiket</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="?page=data-pemesanan">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="?page=data-wisata">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="?page=data-users">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="row">
                        ...
                        if (isset($_GET['page'])) {
                            ...
                            switch ($hal) {
                                ...
                                case 'data-users':
                                    include "datausers/data_users.php";
                                    break;

                                case 'del-users':
                                    include "datausers/del_users.php";
                                    break;

                                case 'data-wisata':
                                    include "datawisata/data_wisata.php";
                                    break;

                                case 'tambah-wisata':
                                    include "datawisata/tambah_wisata.php";
                                    break;

                                case 'del-wisata':
                                    include "datawisata/del_wisata.php";
                                    break;

                                case 'edit-wisata':
                                    include "datawisata/edit_wisata.php";
                                    break;

                                case 'data-pemesanan':
                                    include "datapemesanan/data_pemesanan.php";
                                    break;
